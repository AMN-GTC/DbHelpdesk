...
namespace Helpdesk.Core.Services
{
    ...
    {
        public Task<QuotaCalculation> Insert(QuotaCalculation model, CancellationToken CancellationToken = default);
        public Task<QuotaCalculation> Update(QuotaCalculation model, int id, CancellationToken cancellationToken = default);
